...
// sticky header
	...
	if (get_option('clothing_store_sticky_header', 'off') !== 'off') {
	    $clothing_store_custom_style .= '.menu_header_box.fixed {';
	    $clothing_store_custom_style .= 'position: fixed; background: #fff; box-shadow: 0px 3px 10px 2px #eee;';
	    $clothing_store_custom_style .= '}';
...
$clothing_store_custom_style .='.carousel-caption{';
	...
	$clothing_store_custom_style .='text-align:center; right: 10%; left: 10%;';
...
$clothing_store_custom_style .='.carousel-caption{';
	...
	$clothing_store_custom_style .='text-align:right;right: 15%; left: 20%;';
