...
function clothing_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('clothing_store_read_more_icon',array(
		'default'	=> 'fas fa-arrow-right',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Clothing_Store_Fontawesome_Icon_Chooser(
        $wp_customize,'clothing_store_read_more_icon',array(
		'label'	=> __('Read More Icon','clothing-store'),
		'transport' => 'refresh',
		'section'	=> 'clothing_store_archieve_post_layot',
		'setting'	=> 'clothing_store_read_more_icon',
		'type'		=> 'icon'
	)));
